...
setwd("/mnt/DATA/B_JUN_reseq/O_structural_variation/C_211_noVUL_noINS")

Color <- c("cyan", "red", "gold", "violet", "deepskyblue", "purple4","mediumorchid4", "darkred", "blue1", "lightpink1", "green3", "springgreen4", "yellow", "yellow3", "palegreen", "green", "olivedrab")

####data
samples_info <- read.csv("/mnt/DATA/B_JUN_reseq/O_structural_variation/C_211_noVUL_noINS/sample_info.csv"); head(samples_info)
